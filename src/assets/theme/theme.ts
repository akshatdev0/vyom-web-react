...
declare module "@material-ui/core/styles/createPalette" {
  interface Palette {    
    ...
    vimeo: PaletteColorOptions;
    slack: PaletteColorOptions;
    dribbble: PaletteColorOptions;
    github: PaletteColorOptions;
    buttonLightLabel: SimplePaletteColorOptions;
    sidebarLinks: SimplePaletteColorOptions;
    adminNavbarSearch: SimplePaletteColorOptions;
    authNavbarLink: SimplePaletteColorOptions;
  } 
  ...
  overrides: {
    ...
    MuiButtonGroup: {
      ...
      groupedContainedSecondary: {
        borderColor: themeColors.secondary.main + "!important",
      },
      groupedContainedPrimary: {
        borderColor: themeColors.primary.main + "!important",
      },
      grouped: {
        borderColor: themeColors.dark.main + "!important",
      },
    },
    MuiButton: {
      root: {
    ...
    MuiAvatarGroup: {
      avatar: {
        position: "relative",
        zIndex: "5!important" as CSSProperties['zIndex'],
        border: "2px solid " + themeColors.white.main,
        marginLeft: "-.75rem",
        "&:hover": {
          zIndex: "6!important" as CSSProperties['zIndex'],
        },
      },
    },
    MuiPaginationItem: {
...
theme.palette.sidebarLinks.main;
